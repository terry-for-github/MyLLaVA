...
MODEL_CONSTANTS = {
    MODEL_NAME.CLIP_L_336: {
        ...
        MODEL_ATTRIBUTE.NUM_TOKENS: 576,
    ...
    MODEL_NAME.SIGLIP_SO: {
        ...
        MODEL_ATTRIBUTE.PATCH_SIZE: 14,
        MODEL_ATTRIBUTE.NUM_TOKENS: 729,
    ...
    MODEL_NAME.DINOV2_G: {
        ...
        MODEL_ATTRIBUTE.PATCH_SIZE: 14,
        MODEL_ATTRIBUTE.NUM_TOKENS: 1369,
        MODEL_ATTRIBUTE.HAS_CLS_TOKEN: True,
    ...
    MODEL_NAME.LAYOUTLMV3_L: {
        ...
        MODEL_ATTRIBUTE.HIDDEN_SIZE: 1024,
        MODEL_ATTRIBUTE.PATCH_SIZE: 16,
        MODEL_ATTRIBUTE.NUM_TOKENS: 196,
        MODEL_ATTRIBUTE.HAS_CLS_TOKEN: True,
...
NUM_TOKENS = {k: v[MODEL_ATTRIBUTE.NUM_TOKENS] for k, v in MODEL_CONSTANTS.items()}
...
__all__ = ['IGNORE_INDEX', 'CACHE_DIR',
           'IMAGE_SIZE', 'IMAGE_MEAN', 'HIDDEN_SIZE', 'PATCH_SIZE', 'NUM_TOKENS',
